...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	// The @Param annotation is used to link method parameters to placeholders in
	// JPQL (or HQL) queries. It is a convenient way to write more readable,
	// maintainable, and secure code, especially when you're writing custom queries
